function INCIDENCIA_CustomActions() {
	console.log("INCIDENCIA_CustomActions");

	$("#Placeholder_History").html(DemoTimeLine());
}

function INCIDENCIA__CustomSave() {
	alert("weke");
}


function DemoTimeLine() {
	return "<div class=\"col-xs-12 col-sm-10 col-sm-offset-1\"> \
