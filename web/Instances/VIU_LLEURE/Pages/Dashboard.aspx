...
<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="OpenFrameworkV3.Web.Instances.VIU_LLEURE.Pages.Dashboard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentWorkSpace" Runat="Server">
    <h1>Benvingut a OpenFramework</h1>
</asp:Content>
