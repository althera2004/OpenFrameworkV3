;(function($){
    ...
    var virtualKeyboard = {
        "template": '<div id="vkb-js-keyboard" class="vkb-css-hide">\
                        <div class="vkb-css-background vkb-js-close"></div>\
                        <div class="vkb-css-keyboard-box">\
                            <div class="vkb-css-input-box">\
                                <input type="#TYPE#" id="vkb-js-input" class="vkb-css-input" readonly="readonly" />\
                            </div>\
                        <div class="vkb-css-button-box">\
                            <div class="vkb-css-button-line">\
                                <button type="button">!</button> <button type="button">@</button> <button type="button">#</button> <button type="button">$</button> <button type="button">%</button> <button type="button">^</button> <button type="button">?</button> <button type="button">*</button> <button type="button">/</button>\
                            </div>\
                            <div class="vkb-css-button-line">\
            ...
            return function (e) {
                switch ($(e.currentTarget).attr("id")) {
                    ...
                    case "vkb_CAPS":
                        ...
                        this.CAPS = !this.CAPS;
                        if (this.CAPS === true) {
                            $("#vkb_CAPS").addClass("vkb_CAPS_active");
                            $(".vkb-css-button-box button").css("text-transform", "uppercase");
                        } else {
                            $("#vkb_CAPS").removeClass("vkb_CAPS_active");
                            $(".vkb-css-button-box button").css("text-transform", "lowercase");
                        }
                        break;
                    case "vkb_close":
                        this.keyboard.hide();
    ...
    Vkb.prototype.init = function () {
        var type = "text";
        if (this.config.IsPassword !== "undefined" && this.config.IsPassword !== null && this.config.IsPassword === true) {
            type = "password";
        }
        this.element.addClass(this.config.styleClassParentInput);
        $("body").append(virtualKeyboard.template.split("#TYPE#").join(type));
        ...
        $('<i/>', {
            alt: 'Keyboard',
            class: this.config.styleClassKeyboardIcon + ' vkb-js-key fa fa-keyboard'
        })
