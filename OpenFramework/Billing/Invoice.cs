...
namespace OpenFrameworkV3.Billing
{
    ...
    public partial class Invoice
    {
        ...
        public string PaymentMethodText(string language, string instanceName)
        {
            return ApplicationDictionary.Translate("Billing_PaymentMethod_" + this.PaymentMethod.ToString(), language, instanceName);
        }
        ...
        public static ActionResult SetConfirmed(long id, long companyId, long applicationUserId,string language, string instanceName)
        {
            var res = ActionResult.NoAction;
            var cns = Persistence.ConnectionString(instanceName);
            if (!string.IsNullOrEmpty(cns))
        ...
        public static void RenderPdf(long invoiceId, long companyId,string language, string instanceName)
        {
            ...
            try
            {
                ...
                using (var existingFileStream = new FileStream(fileNameTemplate, FileMode.Open))
                {
                    using (var newFileStream = new FileStream(fileNameNew, FileMode.Create))
                    {
                        ...
                        table.AddCell(HeaderCellRight(ApplicationDictionary.Translate("Billing_Receipt_HeaderPDF_Base", language, instanceName), baseFontBold));
                        table.AddCell(HeaderCellLeft(ApplicationDictionary.Translate("Billing_Receipt_HeaderPDF_IVA", language, instanceName), baseFontBold, 2));
                        ...
                        table.AddCell(CellTableRightResume(ApplicationDictionary.Translate("Billing_Invoice_Label_TotalBaseImponible", language, instanceName), baseFont, odd, 0, 8));
                        ...
                        table.AddCell(CellTableRightResume(ApplicationDictionary.Translate("Billing_Invoice_Label_TotalIVA", language, instanceName), baseFont, odd, 0, 8));
                        table.AddCell(CellTableMoneyResume(totalIVA, baseFontBold, odd, 0));
                        table.AddCell(CellTableRightResume(ApplicationDictionary.Translate("Billing_Invoice_Label_TotalFacturaPDF", language, instanceName), baseFont, odd, 0, 8));
                        ...
                        if (existsAux)
                        {
                            ...
                            if (invoice.Devolucion)
                            {
                                ...
                                {
                                    new Chunk(ApplicationDictionary.Translate("Total preu plaça", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                                ...
                                if (Dias < totalDiasMes)
                                {
                                    resumne.Add(new Phrase
                                    {
                                        ...
                                        new Chunk(" " + ApplicationDictionary.Translate(Dias > 1 ? "Common_Days" : "Common_Day", language, instanceName) + " ", new Font(baseFont, 10, Font.BOLD, BaseColor.BLACK)),
                                ...
                                resumne.Add(new Phrase
                                {
                                    new Chunk(ApplicationDictionary.Translate("Billing_Footer_DevolucioGene", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                                    new Chunk(Basics.SpanishMoney(ImporteGeneralitatDias), new Font(baseFont, 10, Font.BOLD, BaseColor.BLACK))
                                });

                                resumne.Add(new Phrase
                                {
                                    new Chunk(ApplicationDictionary.Translate("Billing_Footer_DevolucioUsuari", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                                    new Chunk(Basics.SpanishMoney(ImporteUsuarioDias), new Font(baseFont, 10, Font.BOLD, BaseColor.BLACK))
                                });

                                resumne.Add(new Phrase
                                {
                                    new Chunk(ApplicationDictionary.Translate("Serveis complementaris", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                                    new Chunk(Basics.SpanishMoney(ServiciosComplementarios), new Font(baseFont, 10, Font.BOLD, BaseColor.BLACK))
                                });

                                resumne.Add(new Phrase
                                {
                                    new Chunk(ApplicationDictionary.Translate("Billing_Footer_DevolucioTotal", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                            ...
                            else
                            {
                                ...
                                switch (invoice.Type)
                                {
                                    case 0: textoGene = ApplicationDictionary.Translate("Billing_Footer_AportacioGenePEVEndosasa", language, instanceName); break;
                                    case 1: textoGene = ApplicationDictionary.Translate("Billing_Footer_AportacioGenePEVNoEndosasa", language, instanceName); break;
                                    case 3: textoGene = ApplicationDictionary.Translate("Billing_Footer_AportacioGene", language, instanceName); break;
                                    case 4: textoGene = ApplicationDictionary.Translate("Billing_Footer_AportacioGene", language, instanceName); break;
                                }
                                ...
                                resumne.Add(new Phrase
                                {
                                    new Chunk(ApplicationDictionary.Translate(invoice.Type < 3  ? "Preu a aplicar a l'usuari" : "Aportació usuari", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                                    new Chunk(Basics.SpanishMoney(ImporteUsuarioDias), new Font(baseFont, 10, Font.BOLD, BaseColor.BLACK))
                                });
                                ...
                                resumne.Add(new Phrase
                                {
                                    new Chunk(ApplicationDictionary.Translate ("Billing_Footer_TotalRebutBancari", language, instanceName) + ": ", new Font(baseFont, 10, Font.NORMAL, BaseColor.BLACK)),
                                    new Chunk(Basics.SpanishMoney(TotalReciboBancario), new Font(baseFont, 10, Font.BOLD, BaseColor.BLACK))
                                });
                        ...
                        foreach (string fieldKey in fieldKeys)
                        {
                            ...
                            {
                                case "FechaFactura":
                                    form.SetField(fieldKey, string.Format(CultureInfo.InvariantCulture, "{0}: {1:dd/MM/yyyy}", ApplicationDictionary.Translate("Billing_Invoice_Label_Date", language, instanceName), invoice.Date));
                                    ...
                                    break;
                                case "FechaVto":
                                    form.SetField(fieldKey, string.Format(CultureInfo.InvariantCulture, "{0}: {1:dd/MM/yyyy}", ApplicationDictionary.Translate("Billing_Invoice_Label_DateVto", language, instanceName), invoice.Date));
                                    form.SetFieldProperty(fieldKey, "textsize", (float)12, null);
                                    form.SetFieldProperty(fieldKey, "textfont", baseFontBold, null);
                                    form.RegenerateField(fieldKey);
                                    break;
                                case "NumeroFactura":
                                    var numberText = string.Format(CultureInfo.InvariantCulture, "{2}: {0:000}/{1}", invoice.Number, invoice.Date.Year, ApplicationDictionary.Translate("Billing_NumFacturaPDF", language, instanceName));
                                    if (invoice.Number < 1)
                                    {
                                        numberText = "PROFORMA";
                                    }
                                    ...
                                    break;
                                case "PaymentMethod":
                                    form.SetField(fieldKey, invoice.PaymentMethodText(language, instanceName));
                        ...
                        Pdf.AbsolutePosition(stamper, ApplicationDictionary.Translate("Billing_Invoice_FooterCurrency", language, instanceName), 1, 60, 15, 400, baseFont, 8);
