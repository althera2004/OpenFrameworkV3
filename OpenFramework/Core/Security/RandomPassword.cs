...
namespace OpenFrameworkV3.Security
{
    ...
    public static class RandomPassword
    {
        ...
        private const string CharsLowercase = "abcdefgijkmnopqrstwxyz";

        /// <summary>Uppercase characters</summary>
        private const string CharsUppercase = "ABCDEFGHJKLMNPQRSTWXYZ";
        ...
        public static string Generate(int minLength, int maxLength)
        {
            ...
            {
                CharsLowercase.ToCharArray(),
                CharsUppercase.ToCharArray(),
