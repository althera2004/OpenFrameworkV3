// --------------------------------
// <copyright file="ColumnTaskMemberGet.cs" company="OpenFramework">
...
{
    /// <summary>Index of columns from "Core_Task_GetMembers" stored procedure</summary>
    public static class ColumnTaskMemberGet
    {
        /// <summary>Index column of "Id" column</summary>
        public const int Id = 0;

        /// <summary>Index column of "TaskId" column</summary>
        public const int TaskId = 1;

        /// <summary>Index column of "UserId" column</summary>
        public const int UserId = 2;

        /// <summary>Index column of "UserName" column</summary>
        public const int UserName = 3;

        /// <summary>Index column of "UserLastName" column</summary>
        public const int UserLastName = 4;

        /// <summary>Index column of "UserLastName2" column</summary>
        public const int UserLastName2 = 5;
