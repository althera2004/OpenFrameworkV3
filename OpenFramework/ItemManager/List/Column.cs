// --------------------------------
// <copyright file="Column.cs" company="OpenFramework">
...
namespace OpenFramework.ItemManager.List
{
    ...
    public sealed class Column
    {
        ...
        /// <summary>Gets or sets a function to render column content based on row data</summary>
        [JsonProperty("RenderData")]
        public string RenderData { get; set; }

        /// <summary>Gets a value indicating whether if columns is shown in filter</summary>
